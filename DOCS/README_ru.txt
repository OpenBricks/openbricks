...
Язык - можно легко выбрать предпочитаемый Вами язык меню, следуя приведенной ниже процедуре:
   ...
   Отредактируйте скрипт generator.sh перед его выполнением и измените строку в начале:    "LANGUAGE=en" на предпочитаемый Вами язык. Например, если Вы француз, измените это так "LANGUAGE=fr".
