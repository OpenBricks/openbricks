...
This archive contain the needed files to install the GeeXboX on a hard drive.
...
When the GeeXboX is installed on a hard drive, it is quite easy to
personalize it.
...
* MPlayer :
    ...
    The options take place in the file GEEXBOX/etc/mplayer/mplayer.conf.
...
* tvout :
    ...
    is done in GEEXBOX/etc/tvsettings. There you can choose the TV standard
    you want (pal, ntsc...) and you can also modify specific options for nvtv.
